              ...
              <div class="card">
                <div class="card-body">
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="firstname" class="form-label">Account_Holder </label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="firstname" class="form-label">Account_Number</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="firstname" class="form-label">Bank_Name</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="firstname" class="form-label">Bank_Branch</label>
                                                    ...
                                                    <div class="col-md-12">
                                                 <div class="mb-3">
                                                 	  <label for="examle-fileinput" class="form-label">Supplier Image</label>
                                                ...
                                                <div class="mb-3">
                                                 	  ...
                                                 	  <img id="showImage" src="{{ url('uplode/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail" 
                                                 	     alt="profile-image">
                                                </div>
                                             </div> <!-- end col -->
