                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="card text-center"> 
                                    <div class="card-body">
                                        <img src="{{ (!empty($adminData->photo)) ? url('uplode/admin_image/'.$adminData->photo) : url('uplode/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data">
                                                 ...
                                                 <div class="col-md-12">
                                                 <div class="mb-3">
                                                 	  <label for="examle-fileinput" class="form-label">Admin Profile Image</label>
                                                 	  <input type="file" name="photo" id="image" class="form-control"></div>
                                                  </div> <!-- end col -->

                                                  <div class="col-md-12">
                                                <div class="mb-3">
                                                 	  <label for="examle-fileinput" class="form-label"></label>
                                                 	  <img id="showImage" src="{{ (!empty($adminData->photo)) ? url('uplode/admin_image/'.$adminData->photo) : url('uplode/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail" 
                                                 	     alt="profile-image">
                                                </div>
                                             </div> <!-- end col -->
